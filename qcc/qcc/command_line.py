...
def parse_cli_args():
    ...
    parser.add_argument('source-file', type=argparse.FileType(mode='r', encoding='utf-8'))
    parser.add_argument('--stats', dest='print_stats', action='store_const', \
...
def main():
    ...
    prog = qcc.compile(args['source-lang'], args['target-lang'],
        args['source-file'])
